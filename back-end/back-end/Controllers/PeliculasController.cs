...
namespace back_end.Controllers
{
    ...
    public class PeliculasController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<PeliculaDTO>>> Filtrar([FromQuery] PeliculasFiltrarDTO peliculasFiltrarDTO)
        {
            ...
            var peliculas = await peliculasQueryable.Paginar(peliculasFiltrarDTO.PaginaciónDTO).ToListAsync();
        ...
        [HttpGet("{id:int}")]
        [AllowAnonymous] //A pesar de tener Authorization al comienzo del controlador, te permite acceder a esta clase.
        public async Task<ActionResult<PeliculaDTO>> Get(int id)
        {
            ...
            if (await context.Ratings.AnyAsync(r => r.peliculaId == id))
            {
